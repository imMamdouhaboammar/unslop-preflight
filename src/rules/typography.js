...
const randomTypeLanguage = /huge (heading|title|text|font)|massive headline|big (bold )?title|very large text|giant text|رزع|random size|any size|\bvery large\b|\bvery big\b|\bhuge\b.{0,30}\b(title|heading|text|font|type)\b|\b(title|heading|text|font|type)\b.{0,30}\bhuge\b|feels? premium.{0,50}\btext\b|premium.{0,30}\bfont\b|bold text where important|big.{0,20}where.{0,20}important/i;
