...
export async function report({ cwd, flags }) { 
  ...
  result.suggestedPrompt = `Inspect PRODUCT.md, DESIGN.md, and ${agentInstructionFile}. Read \`.unslop/fix-list.md\` and resolve any listed issues. Implement the requested scope while preserving existing behavior. **MANDATORY**: Before you complete this task, you MUST run \`npx unslop-preflight audit\` in the terminal, ensure there are 0 errors, and show me the final output score.`;
