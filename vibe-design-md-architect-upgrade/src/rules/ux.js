...
export const uxRules = [
  rule('deterministic-interaction-states', 'DESIGN.md must use deterministic state tokens', 'ux-completeness', 'warning', 'DESIGN.md', (ctx) => {
  ...
  rule('missing-form-validation', 'DESIGN.md needs form validation behavior', 'ux-completeness', 'warning', 'DESIGN.md', (ctx) => {
    const d = ctx.files['DESIGN.md'];
