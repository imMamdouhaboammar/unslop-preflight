...
export const agentRules = [
  rule('missing-do-not-break', 'Missing do-not-break regression rules', 'regression-protection', 'warning', 'AGENT.md', (ctx) => {
  ...
  rule('missing-verification-checklist', 'AGENT.md needs a verification checklist', 'agent-handoff-readiness', 'warning', 'AGENT.md', (ctx) => {
