...
export const productRules = [
  rule('missing-target-users', 'PRODUCT.md needs target users', 'product-clarity', 'warning', 'PRODUCT.md', (ctx) => {
  ...
  rule('missing-acceptance-criteria', 'PRODUCT.md needs acceptance criteria', 'product-clarity', 'warning', 'PRODUCT.md', (ctx) => {
  ...
  rule('missing-non-goals', 'PRODUCT.md needs non-goals', 'risk-control', 'warning', 'PRODUCT.md', (ctx) => {
